        ...
        try:
            for event in events:
                params = {
                    ...
                    "status": event.get("status", "open"),  # default to "open"
                }
