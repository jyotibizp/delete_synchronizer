...
from src.app.salesforce.proto import pubsub_api_pb2 as pubsub__api__pb2
...
class PubSub(object):
    ...
    def ManagedSubscribe(request_iterator,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.stream_stream(request_iterator, target, '/eventbus.v1.PubSub/ManagedSubscribe',
